...
def stats():
    try:
        ...
        if analyses_list:
            ...
            neu_scores = [row['score'] for row in analyses_list if row['label'] == 'NEUTRAL']
            ...
            response_data['time_trends']['neutral'] = [hour_data[h]['NEUTRAL'] for h in response_data['time_trends']['hours']]
